 ...
 * routes V2 through `parsePIARData`, and always returns a
 * fully-populated `PIARFormDataV2` on success. Reading a hand-edited
 * PDF that was opened in another reader and re-saved is supported as
 * long as the hidden field survives the round-trip.
 *
 * @see ./pdf-payload.ts
...
/** Imports PIAR data from a PDF and returns `PIARImportResult` success or failure metadata. */

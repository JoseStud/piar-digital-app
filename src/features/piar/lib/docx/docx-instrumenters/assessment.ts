...
export function instrumentCompetencies(body: Element, doc: Document, factory: ControlFactory): void {
  ...
  const rowMappings = [
    ...
    ['competenciasDispositivos.competenciasLectoras311.cl311_17', 39],
    ['competenciasDispositivos.competenciasLectoras311.cl311_18', 40],
    ['competenciasDispositivos.competenciasMatematicas.cm_1', 43],
    ['competenciasDispositivos.competenciasMatematicas.cm_2', 44],
    ['competenciasDispositivos.competenciasMatematicas.cm_3', 45],
    ['competenciasDispositivos.competenciasMatematicas.cm_4', 46],
    ['competenciasDispositivos.competenciasMatematicas.cm_5', 47],
    ['competenciasDispositivos.competenciasMatematicas.cm_6', 48],
    ['competenciasDispositivos.competenciasMatematicas.cm_7', 49],
    ['competenciasDispositivos.competenciasMatematicas.cm_8', 50],
    ['competenciasDispositivos.competenciasMatematicas.cm_9', 51],
    ['competenciasDispositivos.competenciasMatematicas.cm_10', 52],
    ['competenciasDispositivos.competenciasMatematicas.cm_11', 53],
    ['competenciasDispositivos.competenciasMatematicas.cm_12', 54],
    ['competenciasDispositivos.competenciasMatematicas.cm_13', 55],
    ['competenciasDispositivos.competenciasMatematicas.cm_14', 56],
    ['competenciasDispositivos.competenciasMatematicas.cm_15', 57],
    ['competenciasDispositivos.competenciasMatematicas.cm_16', 58],
    ['competenciasDispositivos.competenciasMatematicas.cm_17', 59],
    ['competenciasDispositivos.competenciasMatematicas.cm_18', 60],
    ['competenciasDispositivos.competenciasMatematicas.cm_19', 61],
    ['competenciasDispositivos.memoria.mem_1', 65],
    ['competenciasDispositivos.memoria.mem_2', 66],
    ['competenciasDispositivos.memoria.mem_3', 67],
    ['competenciasDispositivos.memoria.mem_4', 68],
    ['competenciasDispositivos.memoria.mem_5', 69],
    ['competenciasDispositivos.memoria.mem_6', 70],
    ['competenciasDispositivos.memoria.mem_7', 71],
    ['competenciasDispositivos.atencion.ate_1', 73],
    ['competenciasDispositivos.atencion.ate_2', 74],
    ['competenciasDispositivos.atencion.ate_3', 75],
    ['competenciasDispositivos.atencion.ate_4', 76],
    ['competenciasDispositivos.percepcion.per_1', 78],
    ['competenciasDispositivos.percepcion.per_2', 79],
    ['competenciasDispositivos.percepcion.per_3', 80],
    ['competenciasDispositivos.percepcion.per_4', 81],
    ['competenciasDispositivos.percepcion.per_5', 82],
    ['competenciasDispositivos.funcionesEjecutivas.eje_1', 84],
    ['competenciasDispositivos.funcionesEjecutivas.eje_2', 85],
    ['competenciasDispositivos.funcionesEjecutivas.eje_3', 86],
    ['competenciasDispositivos.funcionesEjecutivas.eje_4', 87],
    ['competenciasDispositivos.funcionesEjecutivas.eje_5', 88],
    ['competenciasDispositivos.funcionesEjecutivas.eje_6', 89],
    ['competenciasDispositivos.lenguajeComunicacion.len_1', 92],
    ['competenciasDispositivos.lenguajeComunicacion.len_2', 93],
    ['competenciasDispositivos.lenguajeComunicacion.len_3', 94],
    ['competenciasDispositivos.lenguajeComunicacion.len_4', 95],
    ['competenciasDispositivos.lenguajeComunicacion.len_5', 96],
    ['competenciasDispositivos.lenguajeComunicacion.len_6', 97],
    ['competenciasDispositivos.lenguajeComunicacion.len_7', 98],
    ['competenciasDispositivos.lenguajeComunicacion.len_8', 99],
    ['competenciasDispositivos.lenguajeComunicacion.len_9', 100],
    ['competenciasDispositivos.lenguajeComunicacion.len_10', 101],
  ] as const;

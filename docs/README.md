...
- [architecture.md](architecture.md) - system overview, workflow hook, section boundaries, offline runtime, export preflights, and build pipeline.
...
- [testing.md](testing.md) - Vitest layout, parallelism, axe coverage, fixtures, and testing patterns.
- [security.md](security.md) - privacy posture, service worker/CSP notes, and vulnerability reporting.
